...
import 'package:unihub/utils/color_collections.dart';
...
ThemeData lightMode = ThemeData(
  ...
  datePickerTheme: DatePickerThemeData(
    backgroundColor: Colors.blue.shade200, // Background of the picker
    headerBackgroundColor: Colors.blue, // Header background
    headerForegroundColor: Colors.white, // Header text & icons
    dayStyle: const TextStyle(color: Colors.blue), // Day text
    todayBorder: BorderSide(color: Colors.blue),// Today's date border
    dividerColor: Colors.blue, // Divider between header & calendar
...
ThemeData darkMode = ThemeData(
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    headerBackgroundColor: Colors.blue[800],
